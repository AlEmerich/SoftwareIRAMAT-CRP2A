...
public class WaterFractionControler extends AbstractFieldControler
{
	private NorthMaterialPanel matFactory;

	public WaterFractionControler(AbstractModel model, NorthMaterialPanel view)
	{
		super(model);
	...
	public void focusLost(FocusEvent e)
	{
		...
		{
			float nb = currentMaterial.getWaterFraction();
			try
			{
			...
			currentMaterial.setWaterFraction(nb);
			model.setChanged();
		}
