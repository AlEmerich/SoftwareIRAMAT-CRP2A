...
public class TopMenu extends JMenuBar
{
     ...
     */
    public TopMenu(final ActionListener parent, boolean run) {
        ...
        final JMenuItem RunDosiSeed = new JMenuItem("Run...");
        RunDosiSeed.setActionCommand("Run");
        RunDosiSeed.addActionListener(parent);
        Project.add(RunDosiSeed);
